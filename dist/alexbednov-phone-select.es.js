      ...
      if (match) {
        ...
        if (cleanCode.startsWith("7")) {
          ...
          const country = getCountries(props.lang).find(
            (c) => c.phone_code.toString().startsWith(cleanCode)
          );
          if (country) {
            selectedCountry.value = country;
            inputValue.value = number;
                ...
                createVNode(unref(_sfc_main$1), null, {
                  default: withCtx(() => [
                    createElementVNode("div", _hoisted_2, [
                      ...
                      selectedCountry.value ? (openBlock(), createElementBlock("span", _hoisted_4, "+" + toDisplayString(selectedCountry.value.phone_code), 1)) : (openBlock(), createElementBlock("span", _hoisted_5, toDisplayString(props.selectPlaceholder || unref(t)("phone-select.select-country")), 1))
                    ])
                  ]),
                  _: 1
                })
...
const PhoneSelect = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3b6b3d68"]]);
export {
  PhoneSelect,
  PhoneSelect as default,
  getCountries,
  getCountryByCode,
  getCountryByName,

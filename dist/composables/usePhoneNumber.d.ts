...
export declare const usePhoneNumber: (lang: Language, favoritesCountries?: string[], hideFavorites?: boolean, onlyCountries?: MaybeRef<string[] | undefined>) => {
    ...
    favorites: import("vue").ComputedRef<(Country | undefined)[]>;
    filteredCountries: import("vue").ComputedRef<Country[]>;
    parsePhoneNumber: (value: string) => void;
    handleSearch: (value: string) => void;
    selectCountryByCode: (code: string) => boolean;
};
